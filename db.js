...
const initialData = {
  ...
  users: [
    ...
    {
      id: 'usr_tt1',
      username: 'tranthimai.qc',
      passwordHash: '123456',
      fullName: 'Trần Thị Mai',
      email: 'tranthimai.qc@school.edu.vn',
      role: 'totruong',
      departmentId: 'to1',
      phone: '0903456789',
      avatar: '',
    ...
    {
      id: 'usr_gv1',
      username: 'nguyenvanan.qc',
      passwordHash: '123456',
      fullName: 'Nguyễn Văn An',
      email: 'nguyenvanan.qc@school.edu.vn',
      role: 'giaovien',
      departmentId: 'to1',
      phone: '0904567890',
      avatar: '',
    ...
    {
      id: 'usr_gv2',
      username: 'phamthithao.qc',
      passwordHash: '123456',
      fullName: 'Phạm Thị Thảo',
      email: 'phamthithao.qc@school.edu.vn',
      role: 'giaovien',
      departmentId: 'to1',
      phone: '0905678901',
      avatar: '',
    ...
    {
      id: 'usr_tt2',
      username: 'levanbinh.qc',
      passwordHash: '123456',
      fullName: 'Lê Văn Bình',
      email: 'levanbinh.qc@school.edu.vn',
      role: 'totruong',
      departmentId: 'to2',
      phone: '0906789012',
      avatar: '',
    ...
    {
      id: 'usr_gv3',
      username: 'dohoanganh.qc',
      passwordHash: '123456',
      fullName: 'Đỗ Hoàng Anh',
      email: 'dohoanganh.qc@school.edu.vn',
      role: 'giaovien',
      departmentId: 'to2',
      phone: '0907890123',
      avatar: '',
    ...
    {
      id: 'usr_gv_nk',
      username: 'vuquoccuong.qc',
      passwordHash: '123456',
      fullName: 'Vũ Quốc Cường',
      email: 'vuquoccuong.qc@school.edu.vn',
      role: 'giaovien',
